...
# RNN Bidirectional LSTM Layer with cross-validation
...
# Output files paths
output_file_txt = os.path.join(output_dir, f"output_LSTM_CV_{current_datetime}_{hash_value}.txt")
output_file_html = os.path.join(output_dir, f"output_LSTM_CV_{current_datetime}_{hash_value}.html")
